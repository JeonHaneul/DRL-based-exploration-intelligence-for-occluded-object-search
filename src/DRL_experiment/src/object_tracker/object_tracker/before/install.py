...
# Download segmentation model file
...
# >>> Download best_hg.pth >>>

server_url = "http://7cmdehdrb.iptime.org:13670/api/public/dl/p2AGo3kE"
filename = "best_hg.pt"
...
install_path = os.path.join(
    os.path.dirname(os.path.dirname(__file__)), "resource/models"
)

# Download object model file
server_url = "http://7cmdehdrb.iptime.org:13670/api/public/dl/0FvLdY-d"
filename = "models.zip"
...
models_zip_path = os.path.join(install_path, "models.zip")
