...
server_url = "http://7cmdehdrb.iptime.org:13670/api/public/dl/kzBlTSlI"
filename = "meshes.zip"
...
if (
    ...
    print(f"Folders already exist in {install_path}. Stop downloading.")
...
# Remove meshes.zip after extraction
