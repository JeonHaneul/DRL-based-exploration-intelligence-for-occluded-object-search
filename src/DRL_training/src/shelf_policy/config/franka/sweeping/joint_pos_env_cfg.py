...
@configclass
class FrankaShelfEnvCfg(ShelfSweepingEnvCfg):
    def __post_init__(self):
        ...
        self.scene.cup2 = RigidObjectCfg(
            ...
            init_state=RigidObjectCfg.InitialStateCfg(pos=[0.93, 0.0, 0.66], rot=[1, 0, 0, 0]),
            spawn=UsdFileCfg(
...
@configclass
class UR5eShelfEnvCfg_PLAY(FrankaShelfEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
