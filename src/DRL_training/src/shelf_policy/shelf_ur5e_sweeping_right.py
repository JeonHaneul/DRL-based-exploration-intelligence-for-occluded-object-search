...
class ShelfSceneCfg(InteractiveSceneCfg):
    ...
    # objects
    cup_1: RigidObjectCfg = MISSING
    cup_2: RigidObjectCfg = MISSING
    cup_3: RigidObjectCfg = MISSING
    mug_1: RigidObjectCfg = MISSING
    mug_2: RigidObjectCfg = MISSING
    mug_3: RigidObjectCfg = MISSING
    can_1: RigidObjectCfg = MISSING
    can_2: RigidObjectCfg = MISSING
    can_3: RigidObjectCfg = MISSING
    bottle_1: RigidObjectCfg = MISSING
    bottle_2: RigidObjectCfg = MISSING
    bottle_3: RigidObjectCfg = MISSING
